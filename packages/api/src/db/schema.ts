...
// --- Agent Traces ---
// Removed: agent_traces and agent_spans tables.
// Tracing now emits OTel-compatible structured JSON logs to stdout.
// Tables may still exist in older databases — left in place, not dropped.
